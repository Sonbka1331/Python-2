...
def fetch_and_save_characters_sequential():
    create_table()
    ...
    for i in range(1, 21):
        ...
        process_character(character_url)

    end_time = time.time()
    execution_time = end_time - start_time
    print(f"Время выполнения последовательного варианта: {execution_time} сек")


def fetch_and_save_characters_concurrent():
    create_table()
    ...
    end_time = time.time()
    execution_time = end_time - start_time
    print(f"Время выполнения параллельного варианта: {execution_time} сек")


if __name__ == '__main__':
    fetch_and_save_characters_sequential()
    fetch_and_save_characters_concurrent()
